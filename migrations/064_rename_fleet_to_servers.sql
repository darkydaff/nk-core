...
UPDATE translations SET translation = 'Search Servers' WHERE key_name = 'fleet_search' AND category = 'dashboard' AND locale = 'en';
UPDATE translations SET translation = 'Пошук серверів' WHERE key_name = 'fleet_search' AND category = 'dashboard' AND locale = 'uk';
UPDATE translations SET translation = 'Поиск серверов' WHERE key_name = 'fleet_search' AND category = 'dashboard' AND locale = 'ru';
...
UPDATE translations SET translation = 'Servers Distribution' WHERE key_name = 'fleet_distribution' AND category = 'map' AND locale = 'en';
UPDATE translations SET translation = 'Розподіл серверів' WHERE key_name = 'fleet_distribution' AND category = 'map' AND locale = 'uk';
UPDATE translations SET translation = 'Распределение серверов' WHERE key_name = 'fleet_distribution' AND category = 'map' AND locale = 'ru';
